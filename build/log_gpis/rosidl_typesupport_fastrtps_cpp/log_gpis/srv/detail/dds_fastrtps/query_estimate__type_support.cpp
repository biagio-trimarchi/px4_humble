...
#include "log_gpis/srv/detail/query_estimate__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = log_gpis::srv::QueryEstimate_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const log_gpis::srv::QueryEstimate_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<log_gpis::srv::QueryEstimate_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _QueryEstimate_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const log_gpis::srv::QueryEstimate_Request *>(
...
static size_t _QueryEstimate_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_QueryEstimate_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _QueryEstimate_Request__callbacks = {
  "log_gpis::srv",
...
static rosidl_message_type_support_t _QueryEstimate_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_QueryEstimate_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_log_gpis
const rosidl_message_type_support_t *
get_message_type_support_handle<log_gpis::srv::QueryEstimate_Request>()
{
  return &log_gpis::srv::typesupport_fastrtps_cpp::_QueryEstimate_Request__handle;
}
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.gradient_estimate;
  }
  // Member: hessian_estimate
  {
    cdr << ros_message.hessian_estimate;
  }
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 3;
    size_t item_size = sizeof(ros_message.gradient_estimate[0]);
  ...
  {
    size_t array_size = 9;
    size_t item_size = sizeof(ros_message.hessian_estimate[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = log_gpis::srv::QueryEstimate_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const log_gpis::srv::QueryEstimate_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<log_gpis::srv::QueryEstimate_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _QueryEstimate_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const log_gpis::srv::QueryEstimate_Response *>(
...
static size_t _QueryEstimate_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_QueryEstimate_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _QueryEstimate_Response__callbacks = {
  "log_gpis::srv",
...
static rosidl_message_type_support_t _QueryEstimate_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_QueryEstimate_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &log_gpis::srv::typesupport_fastrtps_cpp::_QueryEstimate_Response__handle;
}
...
static service_type_support_callbacks_t _QueryEstimate__callbacks = {
  "log_gpis::srv",
  "QueryEstimate",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, log_gpis, srv, QueryEstimate_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, log_gpis, srv, QueryEstimate_Response)(),
...
static rosidl_service_type_support_t _QueryEstimate__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_QueryEstimate__callbacks,
...
{
  return &log_gpis::srv::typesupport_fastrtps_cpp::_QueryEstimate__handle;
}
